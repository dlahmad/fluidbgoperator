...
| `nats` | JetStream no-loss or core best-effort subject fanout, weighted splitting, output combining, observation, writing, and consumption for NATS. | [NATS Plugin](nats.md) |
