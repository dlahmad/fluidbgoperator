...
use config::{AppState, load_config, rabbitmq_amqp_url_from_env};
...
const DEFAULT_LOG_FILTER: &str = "warn,fluidbg_rabbitmq=info";
...
mod tests {
    ...
    #[test]
    fn writer_and_observer_do_not_disable_rabbitmq_worker_roles() {
        assert_eq!(
            queue_worker_role(&[
                PluginRole::Combiner,
                PluginRole::Observer,
    ...
    #[test]
    fn rabbitmq_rejects_conflicting_movement_roles() {
